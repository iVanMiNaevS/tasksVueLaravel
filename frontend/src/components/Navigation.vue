<template>
	<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white bg-dark" style="width: 280px">
		<a href="/" class="d-flex align-items-center mb-3 gap-3 mb-md-0 me-md-auto text-white text-decoration-none">
			<img src="./static/icon.svg" style="width: 30px" alt="" />
			<span class="fs-4">Tasks Storage</span>
		</a>
		<hr />
		<ul class="nav nav-pills flex-column mb-auto">
			...
			<li class="nav-item">
				<router-link to="/task-shared" class="nav-link text-white d-flex align-items-center gap-2">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="16"
						height="16">
						<path fill-rule="evenodd"
			...
			<li class="nav-item">
				<router-link to="/task-add" class="nav-link text-white d-flex align-items-center gap-2">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="16"
						height="16">
						<path
		...
		<hr />
		<ul class="nav nav-pills flex-column" @click="logout">
			<li class="nav-item">
